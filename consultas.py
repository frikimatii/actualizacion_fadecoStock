...
def consultorio(notebook):
    ...
    tabla_consultas.heading("Cantidad", text="Cant",command=lambda: sort_column(tabla_consultas, "Cantidad", False))
    ...
    tabla_consultas.column("Cantidad", anchor=tk.W, width=40)
    tabla_consultas.column("Modelo", anchor=tk.W, width=90)
