...
def inicio(notebook):
    ...
    box1.grid(row=0, column=0, sticky="nsew", padx=50, pady=50)



    # Insertar una imagen en lugar de texto
    image_path1 = "C:/Fadeco/img/fadeco_logo.png"  # Reemplaza con la ruta real de tu imagen en formato PNG
    ...
    titulo.grid(row=0 ,column=0 , sticky="esw", padx=10, pady=10)
    

    image_path2 = "C:/Fadeco/img/Cortadora.png"  # Reemplaza con la ruta real de tu imagen en formato PNG
